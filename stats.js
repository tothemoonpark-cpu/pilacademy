...
(function (global) {
  ...
  */
  var SCHOOL_HISTORY = [
    {
      year: '2026년',
      schools: [
        '26.12.31 경북 구미 옥계동부중학교 (전교생 761명 · 학년별 각 45분 3회) (예정)',
        '26.12.9 남도여자중학교 (전교생 210명, 1시간 북콘서트) (예정)',
        '26.11.11 김해중앙여자고등학교 (김해진로교육지원센터 「학교로 찾아가는 직업체험」, 1차시 특강 2회) (예정)',
        { text: '26.10.24 김해 진로 토크콘서트 (김해진로교육지원센터 주최 · 김해시청소년센터 · 중·고등학생 40명 내외 · 90분) (예정)', isSchool: false },
        '26.7.16 내성중학교',
        '26.7.15 김해 대청고등학교',
  ...
  var SITE_STATS = {
    ...
    columnOutlets: 26,      // ⭐ **「현재 연재 중」 매체 수** — 2026-09-03 세계일보 「펫 상실학 개론」 연재 시작으로 25→26
                            // ⛔ columns.html 의 「30개 매체 319편」과 다른 축이다(그쪽은 **누적 게재** 매체).
                            //    어긋난 것이 아니므로 맞추려 하지 마라 — 2026-09-09 실측·판정.
    pressBook: 31,          // 신간 출간 보도 매체 수
    pressLecture: 23,       // 자립지원관 특강 보도 매체 수
    followers: '2.6만',     // SNS 팔로워
    vodCount: 5,            // 자체 VOD 강좌 수

    asOf: '2026.9'          // 기준 시점 (수치 옆에 함께 노출)
  };
